...
export function ShareOptions({ score, title, message }: ShareOptionsProps) {
  ...
  const shareLinks = [
    ...
    },
    {
      ...
      action: () => {
        window.open(
          `https://www.producthunt.com/posts/new?url=${encodeURIComponent(shareUrl)}&name=Will+You+Stay+Single+Forever?&tagline=${encodeURIComponent("Find out your single score this Valentine's")}`,
          "_blank",
        )
      },
    },
